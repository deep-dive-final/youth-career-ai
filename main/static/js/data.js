...
const POLICIES = [
  {
    ...
    requirements: ['만 19~34세', '무주택자', '중위소득 150% 이하', '보증금 5천만원 이하 월세 거주'],
  ...
  },
  {
    ...
    type: '서비스',
    income: '중위소득 180% 이하',
    description: '5년간 매월 70만원 납입 시 정부기여금으로 최대 5,000만원 목돈 마련',
    requirements: ['만 19~34세', '개인소득 6,000만원 이하', '가구소득 중위 180% 이하'],
